...
void configure_denseD(Eigen::VectorXd& x, Eigen::MatrixXd& denseD, Eigen::VectorXd& s_seq,
      int& k, bool& equal_space) {
    int n = x.size();
    Eigen::SparseMatrix<double> dk_mat = get_Dtil(k, Rcpp::wrap(x));
